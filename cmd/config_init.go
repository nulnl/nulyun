...
var configInitCmd = &cobra.Command{
	...
	Long: `Initialize a new database to use with Nul Yun. All of
this options can be changed in the future with the command
'nulyun config set'. The user related flags apply
...
override the options.`,
	...
	RunE: withStore(func(cmd *cobra.Command, _ []string, st *store) error {
		...
		fmt.Printf(`
Congratulations! You've set up your database to use with Nul Yun.
Now add your first user via 'nulyun users add' and then you just
